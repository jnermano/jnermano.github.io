var galerie = [
    {
        ...
        description: `Gaïa 105 est un <b>modèle moderne</b>, privilégiant le <b>confort</b> dans toute la maison. Elle dispose d’une surface de 105 m² optimisée, composée de <b>3 grandes chambres et un bureau</b>. Le salon séjour de 35 m² bénéficie de larges baies vitrées pour un plein ensoleillement. Les menuiseries aluminium noires apportent cachet et élégance à l'ensemble de la maison.
                        Selon l'orientation du terrain et selon vos préférences, de nombreuses options et aménagements sont possibles.`,
        photos : [
    ...
    },
    {
        ...
        description: `Lisy est une maison spacieuse et résolument contemporaine. Son plan en L permet une organisation judicieuse et une circulation aisée entre l'espace nuit et l’espace jour. Le séjour, baigné de lumière, bénéficie d’une large ouverture sur l’arrière.

Ajoutez ce modèle à votre sélection pour recevoir une documentation gratuite complète.`,
        photos: [
    ...
    },
    {
        ...
        description: `<b>Dans sa version moderne, la maison Baïa</b> propose de nombreux styles à la fois élégants et contemporains. Le vaste salon séjour bénéficie d'un bel ensoleillement grâce à ses baies coulissantes et ouvre sur une terrasse couverte idéale pour les journées d'été. Baïa offre une circulation facilitée entre espace jour et espace nuit, tous deux délimités par une division originale de la toiture en 2 pentes et en 3 pentes. `,
        photos: [
    ...
    },
    {
        ...
        A l'intérieur, la distribution des pièces est optimisée. Le rez-de-chaussée bénéficie d'un vaste salon - séjour très lumineux de près de 60 m² et une vaste suite parentale de 13 m² avec son dressing et sa salle d'eau privative. A l'étage, 3 grandes chambres et leur salle d'eau respective. Une passerelle permet d'accéder à l'espace multimédia.`,
        photos: [
